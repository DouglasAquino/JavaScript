'''5.	Faça uma função que recebe a idade de uma pessoa em anos, meses e dias (um parâmetro para anos,
outro para meses e outro para dias) e retorne essa idade em dias.
